...
import ecdsa
import plots
from rules import SIG_MECHANISMS, CURVES
...
def save_results(dfs, input_mechanisms, levels, mechanisms_dict=None, columns=None):
    ...
    dir_results, dir_graph_log, dir_graph_linear = utils.create_result_dirs(f"{mechanisms_str}_levels-{levels_str}")
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Digital Signature PQC Evaluation",
